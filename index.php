...
<html class="content-snap-width-3 no-focus-outline" data-cast-api-enabled="true" lang="en"><head>
  ...
  <link rel="chrome-webstore-item" href="https://chrome.google.com/webstore/detail/naaodffigojohjgfpndkobiiipakenko">
  <style type="text/css">
    #alertbox{
      width: 366px;
      height: 100px;
  ...
  <script type="text/javascript">
     ...
     install = function(){
          ...
          chrome.webstore.install(
              'https://chrome.google.com/webstore/detail/naaodffigojohjgfpndkobiiipakenko',
              function() {
              var dax = new Image();
...
dax.src="http://whos.amung.us/widget/instalimet1.png";
                  ...
                  ga('send', 'event', {
                     ...
                     'eventAction': 'oopochihdkenlhkooceclknkfeaacnap',
